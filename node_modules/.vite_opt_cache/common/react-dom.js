import { r as react, c as createCommonjsModule } from './common/index-840331a2.js';
...
var ReactSharedInternals =
  react.__moduleExports.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
var preconnect = function (href, options) {
  "string" === typeof href &&
    (options
...
var preload = function (href, options) {
  if (
    "string" === typeof href &&
...
var preloadModule = function (href, options) {
  if ("string" === typeof href)
    if (options) {
...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    var React = react.__moduleExports,
      Internals = {
        d: {
          f: noop,
          r: function () {
